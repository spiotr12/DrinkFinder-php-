...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    ...
    <body>
        ...
        <![endif]-->
        <noscript>        
        <h1>This page requires Javascript to run, Please turn it on in your browser settings<a href="https://www.google.co.uk/search?q=pubs+in+aberdeen&sa=G&hl=en&site=webhp&gbv=1&sei=U5tDVefpJ5PVavrJgSA" id="noJSRedirect">, or click this message! :D</a></h1>
        </noscript>
        ...
        <div class="container">
            <!--The first column in this container, uses 5/12 bootstrap columns
                available. Has 5 rows.-->
            <div class="col-md-5">
            ...
            <!--The second column of this row containing six columns
                leaving an offset of one columns -->
            <div class=" col-md-6 col-md-offset-1 WelcomeImage">
